...
<html  class="js flex mobile" lang="en">
   ...
   <body>
            ...
            <div class="top-content">
               <div class="inner-bg">
                  <div class="container">
                     ...
                     <div class="row">
						<!-- information of the click report -->
						<div class="reportInfo">
                            ...
                            <table class="table table-bordered">  
								...
								<?php
									...
									/* store images of report in an array*/
									while ($row = $result->fetch_assoc()) {
										$reportImages[] = $row['image']; 
									}
									
									//make each image clickable and display them
									for($l = 0; $l < sizeof($reportImages); $l++){
										if($l % 3 == 0 ){
											echo '<tr>';
										}

	
										// $ImagesArray[$j] ='<img id = "imgs'.$l.'" src="data:image/jpeg;base64,'.base64_encode($reportImages[$l] ).'" height="200" width="200" class="img-thumnail" />';
										$src = "data:image/jpeg;base64," .base64_encode($reportImages[$l] );
										$val = 0;
											
										echo '
										<td> 
										
										<img id = "imgs" src="'.$src.'" height="200" width="200" class="img-thumnail" onclick="openImage()" />
	  ...
	  <script type="text/javascript">
			...
			// document.getElementById('category').innerHTML = catArray;
            document.getElementById('title').innerHTML = "<strong>" + reportTitle + "</strong>";
			// document.getElementById('repSummary').innerHTML = reportSummary;
			document.getElementById('info').innerHTML = "<h3>Reported in the "+catArray+" category on "+ reportDate+" <br> <b>Images</b><br>" + reportSummary + "</h3>" ;
