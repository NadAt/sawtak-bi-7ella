...
<html  class="js flex mobile" lang="en">
   ...
   <body>
	  ...
	  <script type="text/javascript">
            ...
            document.getElementById('title').innerHTML = reportTitle;
			// document.getElementById('repSummary').innerHTML = reportSummary;
			document.getElementById('info').innerHTML = "Reported in the "+catArray+" category on <b>date</b> <br> <b>Images</b><br>" + reportSummary ;
