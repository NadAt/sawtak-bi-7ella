...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="assets/css/styleC.css">
...
$conn=mysqli_connect("localhost","root","","299V2");
?>
...
<div class="cmt-container" >
    ...
    $sql = $conn->query("SELECT * FROM comments WHERE report_Id = '9'") or die(mysql_error());;
